...
FIELDS = (
    ...
    ("Uptime warning threshold", "steamroller_uptime_warning_days", 30, " days"),
    ("Uptime high threshold", "steamroller_uptime_high_days", 90, " days"),
    ("Uptime critical threshold", "steamroller_uptime_critical_days", 200, " days"),
